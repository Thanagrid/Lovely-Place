...
CREATE TABLE IF NOT EXISTS `posts` (
  ...
  `post_title` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `post_preDes` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `post_descript` text CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `post_img` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `reports` (
  ...
  `report_message` text CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `user_id` int(255) NOT NULL,
